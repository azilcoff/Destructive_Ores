package net.azilcoff.dores.world;
...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap (Registerable<ConfiguredFeature<?, ?>> context){
        ...
        registerFeature(context, URANIUM_ORE_KEY, Feature.ORE, new OreFeatureConfig(overworldUraniumReplaceables,2));
    }
    ...
    private static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String id){
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(DestructiveOres.MOD_ID, id));
    }
}
